  ...
  return (
    <div ref={containerRef} className={cn("relative", className)}>
      <button
        ...
        className="flex w-full items-center justify-between gap-2 rounded-md border border-border bg-background px-3 py-2 text-sm hover:bg-accent transition-colors"
      >
      ...
      {open && (
        <div className="absolute top-full left-0 right-0 mt-1 max-h-64 overflow-y-auto bg-popover border border-border rounded-md shadow-lg z-50 py-1">
          {/* None option */}
          <button
            type="button"
            onClick={() => {
