        ...
        <div className="fixed right-0 top-0 bottom-0 w-80 bg-card border-l border-border shadow-xl z-20 flex flex-col">
          <div className="flex items-center justify-between p-4 border-b border-border">
            ...
            <div className="flex items-center gap-1">
              <Button
                ...
                className={cn(selected.is_starred && "text-yellow-500")}
              >
          ...
          <div className="flex-1 overflow-auto p-4 space-y-4">
            ...
            {selected.needs_review && (
              <div className="flex items-start gap-2 text-xs bg-amber-50 dark:bg-amber-950 border border-amber-200 dark:border-amber-800 rounded-md p-2 text-amber-800 dark:text-amber-200">
